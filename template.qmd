...
::: {.toc-item}
<iconify-icon icon="mdi:circle-outline"></iconify-icon> Part 2: Custom Components & Layouts
:::
...
## Configuration YAML (`title-config`) {.smaller}
...
# Part 2: Custom Components & Layouts
...
::: {.toc-item .active}
<iconify-icon icon="mdi:play-circle"></iconify-icon> Part 2: Custom Components & Layouts
:::
...
::: {.toc-item .past}
<iconify-icon icon="mdi:check-circle"></iconify-icon> Part 2: Custom Components & Layouts
:::
